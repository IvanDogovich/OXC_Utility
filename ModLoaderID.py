# Taking a stab at trimming down Stoddard's code for my own tool
#!/usr/bin/env python3

#todo:
# Convert ''' comments to # ==done
# Trim all the find the path logic.  This will be handled by a config file in the path of the too
...
# I don't think this finder piece is needed.  All the path work will be set in file.
class Finder(object):
...
## doubt we really need to track the metadata.  I suppose we could use this to pass in the version when done.
...
## Shouldn't need to merge in extrastrings. they are in Piratez strings file. (ID)
...
PRIMARY_KEYS = {
    ...
    'research': 'name',
    'manufacture': 'name',  # This is our key of interest
    'terrains': 'name',
...
#probably don't need to load vanilla
...
# ugh.  Dont know what to do with that horrible comment below.
